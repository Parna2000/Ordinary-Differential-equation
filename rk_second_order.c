...
// this is d2y/dx2= dz/dx
double d2f(double x, double y, double z)
{
    double f2;
    f2 = 0.5*((45*exp(2*x))+(3*y)+(5*z));
    return f2;
}
...
int main()
{
    ...
    double x, y, h, x1, z;
    printf("Enter the value of x[0] and y[0] and y'[0]:\n");
    scanf("%lf %lf %lf", &x, &y, &z);
    printf("Enter the value of h:\n");
    scanf("%lf", &h);
    printf("Enter x1 for which you want to find y(x1) and y'(x1):\n");
    scanf("%lf", &x1);
    rk4o2(x, y, z, h, x1);
    return 0;
}